...
?>
 ...
 <div class="form-group">
    <label class="control-label col-sm-2" for="tt">Trip Type:</label>
      <div class="col-sm-10">          
            <select class="custom-select" id="tt" name="tt">
            <option value="One way Trip" onclick="hide()" selected>One way Trip</option>
            <option value="Round Trip" onclick="display()" >Round Trip</option>
            </select>
      </div>
  </div>
<div class="form-group">
